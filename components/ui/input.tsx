  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        ...
        className={cn(
          // Layout & Base Styles
          "flex h-10 w-full rounded-md border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 px-4 py-2 text-xs font-mono font-bold shadow-sm transition-all duration-300",
