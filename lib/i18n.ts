...
export const translations = {
  en: {
    ...
    automation_timer: "Automation Timer",
    init_timer: "Initialize Timer",
    shift_register: "Shift Register (74HC595)",
    weather_station: "Weather Station (DHT)",
    active_timeline: "Active Timeline",
    active_status: "ACTIVE",
    offline_status: "OFFLINE",
    zone: "ZONE",
    nodes: "Nodes",
    node: "Node",
    protocol_injector: "Protocol Injector",
    auto_action_in: "Auto-Action In",
    runtime: "Runtime",
    mode: "Mode",
  ...
  fa: {
    ...
    action_on: "روشن کردن (ON)",
    action_off: "خاموش کردن (OFF)",
    action_toggle: "تغییر وضعیت",
    action_set_value: "تنظیم مقدار خروجی",
    set_pwm_val: "مقدار خروجی (۰-۲۵۵)",
    digital_only: "در حال حاضر محدود به دستگاه‌های دیجیتال است.",
    output_segments: "بخش‌های خروجی",
    input_sensors: "سنسورهای ورودی",
    hardware_templates: "قالب‌های سخت‌افزار",
    system_core: "هسته سیستم",
    automation_timer: "تایمر خودکار",
    init_timer: "راه‌اندازی تایمر",
    shift_register: "شیفت رجیستر (74HC595)",
    weather_station: "ایستگاه هواشناسی (DHT)",
    active_timeline: "خط زمانی فعال",
    active_status: "فعال",
    offline_status: "غیرفعال",
    zone: "بخش",
    nodes: "گره",
    node: "گره",
    protocol_injector: "تزریق پروتکل (Code)",
    auto_action_in: "عملیات خودکار در",
    runtime: "مدت زمان کارکرد",
    mode: "حالت",
