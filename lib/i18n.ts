...
export const translations = {
  en: {
    ...
    release_delete: "Release to Delete",
    release_delete_segment: "Release to Delete Segment",
    release_delete_group: "Release to Delete Group",
  ...
  fa: {
    ...
    release_delete_segment: "رها کنید تا سگمنت حذف شود",
    release_delete_group: "رها کنید تا گروه حذف شود",
